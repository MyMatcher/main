...
public class ServletForm extends HttpServlet {
	...
	/**
	 * Método loginUsuario() que sirve para iniciar sesión en la aplicación como un usuario normal
	 * 
	 * @param request
	 * @param response
	 * @throws Exception
	...
	/**
	 * Método loginAdmin() que sirve para iniciar sesión en la aplicación como un administrador
	 * 
	 * @param request
	 * @param response
	 * @throws Exception
	...
	/**
	 * Método insertarUsuario() que sirve para insertar un usuario nuevo
	 * 
	 * @param request
	 * @param response
	 * @throws Exception
	...
	/**
	 * Método actualizarAtributos() que actualiza los atributos elegidos por el usuario
	 * 
	 * @param request
	 * @param response
	 * @throws Exception
	...
	/**
	 * Método mostrarError() que srive para controlar los errore que puedan surgir
	 * 
	 * @param response
	 * @throws IOException
	 */
