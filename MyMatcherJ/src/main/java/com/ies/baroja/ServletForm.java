...
public class ServletForm extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (request.getParameter("user") != null) {
				...
				insertarAtributos(request, response);
	...
	private static void insertarAtributos(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/** 2- Insertar jugador en la base de datos */
		int iUpd = Controller.insertarAtributos(null, usuario);
