...
public class Controller {
	...
	/**
	 * Métdoo getUsuarios() para obtener una lista de todos los usuarios de la base de datos
	 * 
	...
	/**
	 * Método getMyMatch() que busca si un usuario tiene algún atributo en común con otro usuario
	 * 
	...
	/**
	 * Método getUsuario() que obtiene todos los datos de un usuario en concreto con el parámetro "sNombreUsuario"
	 * 
	 * @param sNombreUsuario
	 * @return miUsuario
	 */
