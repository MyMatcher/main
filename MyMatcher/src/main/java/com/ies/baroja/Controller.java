	...
	public static LinkedList<Usuarios> getMyMatch(String sNombreUsuario) {
		...
		try {
			String sConsultaMyMatch = "SELECT * FROM usuarios \r\n"
					+ "	WHERE user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo1 IN (SELECT atributo1 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo2 IN (SELECT atributo2 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo3 IN (SELECT atributo3 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo4 IN (SELECT atributo4 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo5 IN (SELECT atributo5 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo6 IN (SELECT atributo6 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo7 IN (SELECT atributo7 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo8 IN (SELECT atributo8 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo9 IN (SELECT atributo9 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo10 IN (SELECT atributo10 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo11 IN (SELECT atributo11 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo12 IN (SELECT atributo12 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo13 IN (SELECT atributo13 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo14 IN (SELECT atributo14 FROM usuarios WHERE user='"+sNombreUsuario+"')\r\n"
					+ "		OR user NOT IN (SELECT user FROM usuarios WHERE user='"+sNombreUsuario+"') AND atributo15 IN (SELECT atributo15 FROM usuarios WHERE user='"+sNombreUsuario+"');";
