...
public class Controller {
	...
	private static String sConsulta="select user, password, nombre, apellidos, fechanac, correo, descripcion, "
			+ "atributo1, atributo2, atributo3, atributo4, atributo5, "
			+ "atributo6, atributo7, atributo8, atributo9, atributo10, "
			+ "atributo11, atributo12, atributo13, atributo14, atributo15 from usuarios where user='Javi';";
